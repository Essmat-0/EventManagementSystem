...
public class CustomerService {
    ...
    public Event createEvent(String title, String location, int attendeesCount) {
    if (customer == null) {
        System.out.println("✗ No customer logged in");
        return null;
    }

    int eventId = idGen.generateEventID();
    ...
    public Reservation bookEvent(Event eventDetails) {
        ...
        NotificationService.sendEmail(
                ...
                "Reservation Number: " + newReservation.getReservationNumber()
